...
export default function App() {
  const { 
    ...
    zoomOut, exportJSON, importJSON, setMousePosition, loadProject,
  ...
  const handleNewProject = () => {
    // Start with a completely blank editor (do not restore previous "memory")
    createNewGraph({ confirm: false });
    setView("builder");
  };
  ...
  return (
    <div
      className={`w-screen min-h-screen bg-[#020617] relative ${view === "builder" ? "overflow-hidden" : "overflow-auto"}`}
    >
