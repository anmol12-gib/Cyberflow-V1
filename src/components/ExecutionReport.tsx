      ...
      <div className="w-full max-w-[440px] bg-[#050505] border border-white/10 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-6">
          <p className="text-[10px] text-slate-600 leading-relaxed">
            Tip: “Halting Latency” measures how long execution waited while reaching disabled nodes. “Throughput” reflects effective processing speed after accounting for halts.
          </p>
        </div>
